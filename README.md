...
面向电力行业的多场景解决方案生成 Agent 项目仓库。  
当前仓库已经覆盖：

- 多场景解决方案生成 Agent 的产品、技术、研发文档
- 客户需求分析智能体的产品、技术与研发设计
- Django 平台层、Agent Service、Vue 前端的项目骨架与核心实现
- RAGFlow 本地部署脚手架
- 真实测试结果、评审版 HTML / PDF、方案模板与参考资料

项目当前的目标不是做一个单点聊天机器人，而是构建一个可持续扩展的电力行业解决方案生成平台，支持：
...
后端代码已开始在 Django 平台层新增 `customer_demand` 业务域。
