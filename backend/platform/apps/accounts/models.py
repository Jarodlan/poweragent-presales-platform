...
class User(AbstractUser):
    ...
    feishu_user_access_token = models.TextField(blank=True)
    feishu_user_refresh_token = models.TextField(blank=True)
    feishu_user_token_expires_at = models.DateTimeField(null=True, blank=True)
    feishu_user_refresh_expires_at = models.DateTimeField(null=True, blank=True)
    feishu_personal_task_auth_status = models.CharField(max_length=16, default="unbound")
    feishu_personal_task_authorized_at = models.DateTimeField(null=True, blank=True)
    sync_source = models.CharField(max_length=16, choices=SYNC_SOURCE_CHOICES, default="platform")
