...
PERMISSION_SEEDS = [
    ...
    PermissionSeed("presales_task.view", "查看售前任务", "presales_task", "view", "self", "查看本人负责的售前任务。"),
    PermissionSeed("presales_task.view_all", "查看全部售前任务", "presales_task", "view_all", "platform", "查看平台内全部售前任务。"),
