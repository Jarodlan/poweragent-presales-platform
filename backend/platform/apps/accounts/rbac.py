...
PERMISSION_SEEDS = [
    ...
    PermissionSeed("presales_center.access", "进入售前闭环中心", "presales_center", "access", "self", "进入售前闭环智能体平台模块。"),
    PermissionSeed("presales_task.view", "查看售前任务", "presales_task", "view", "self", "查看本人负责或参与的售前任务。"),
    PermissionSeed("presales_task.manage", "管理售前任务", "presales_task", "manage", "platform", "创建、编辑、完成和发送售前任务。"),
    PermissionSeed("presales_archive.view", "查看售前归档", "presales_archive", "view", "self", "查看售前归档记录。"),
    PermissionSeed("presales_archive.manage", "管理售前归档", "presales_archive", "manage", "platform", "创建与维护售前归档。"),
    PermissionSeed("crm.access", "查看 CRM 联通能力", "crm", "access", "self", "查看 CRM 搜索、绑定和写回结果。"),
    PermissionSeed("crm.bind", "绑定 CRM 记录", "crm", "bind", "self", "将平台对象绑定到 CRM 客户或商机记录。"),
    PermissionSeed("crm.writeback", "写回 CRM 记录", "crm", "writeback", "self", "将需求分析、方案结果、任务和归档写回 CRM。"),
    PermissionSeed("crm.manage", "管理 CRM 配置", "crm", "manage", "platform", "管理 CRM 接入配置、表结构和写回策略。"),
    PermissionSeed("feishu_delivery.view", "查看飞书发送记录", "feishu_delivery", "view", "platform", "查看飞书发送记录。"),
    PermissionSeed("feishu_delivery.manage", "管理飞书发送", "feishu_delivery", "manage", "platform", "发起飞书发送并处理失败记录。"),
    PermissionSeed("feishu_sync.manage", "管理飞书同步任务", "feishu_sync", "manage", "platform", "触发和查看飞书用户与部门同步任务。"),
